    ...
    return (
        <section className="contact">
            ...
            <form className="contact__form" action="/contact.json">
                ...
                <Label for="name" className="contact__form--name-label"><LabelText>YOUR NAME:</LabelText></Label>
                ...
                <Label for="email" className="contact__form--email-label"><LabelText>YOUR EMAIL:</LabelText></Label>
                ...
                <input className="contact__form--send" type="submit" value="SEND FORM" />
